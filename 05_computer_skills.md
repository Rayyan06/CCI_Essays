...
MATLAB: Thermal modeling for Mug Warmer Project, vehicle dynamics simulation for RC car project, matrix analysis, and data visualization. Spring 2026: numerical simulation of differential equations, dynamic mechanical systems, and electric circuits.
...
LTSpice: Introduced to this in IEEE club, utilizing for SPICE simulation and nodal/mesh analysis verification in Circuit Analysis (Spring 2026).
